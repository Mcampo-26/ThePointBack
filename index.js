...
const io = new Server(server, {
  cors: {
    origin: ['https://thepointdev.netlify.app'], // Reemplaza con la URL de tu frontend
    methods: ['GET', 'POST'],
  },
});
...
app.use(cors({
  origin: ['https://thepointdev.netlify.app'], // Permite solicitudes desde el dominio de tu frontend
